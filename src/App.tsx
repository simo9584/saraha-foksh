          ...
          <div className="bg-white rounded-xl shadow-xl overflow-hidden text-gray-900">
            <div className="text-center p-6">
              <h1 className="text-gray-900 text-xl mb-6 font-bold">
                اكتب رسالة إلى فوكش دون أن يعرفك
              </h1>
              ...
              <h2 className="text-xl font-bold text-gray-900 mb-4">فوكش</h2>
          ...
          <div className="text-center p-6 text-gray-900">
            {isLoading ? (
              ...
              <div className="space-y-4">
                <p className="text-lg mb-2">للاسف لا يمكنك إرسال رسالة إلى فوكش حالياً يجب عليك إنشاء حساب أولاً</p>
                <p className="text-lg mb-4">يجب عليك أولاً إنشاء حساب صراحة لكي يمكنك مصارحة فوكش</p>
                <button
